                ...
                <section key={id} className='flex flex-col justify-center  bg-white mx-auto mt-[8rem] py-4 px-2 shadow-md rounded-xl sm:px-0 sm:max-w-[600px] sm:min-w-[600px] md:min-w-[600px] md:max-w-[600px]  lg:max-w-[800px] lg:min-w-[800px] xl:min-w-[800px]'>
                    ...
                    {openListId === id &&
                        <div>
                            ...
                            <button onClick={() => postDataToActualList(id, foodsData, Navigate)} className='hover:bg-[#4A55AA] transition-all duration-500 mt-8 bg-black text-white block font-extrabold  px-2 py-2  rounded-xl mx-auto '>Dodaj listę do 'Chmury'</button>
