...
const Home = () => {
    return (
        <div className='w-full font-lol'>
            ...
            <div className='flex flex-col justify-center items-center max-w-[90%] mx-auto mt-[4rem] gap-4 shadow-2xl py-8 rounded-2xl px-4 bg-[#000B70] bg-opacity-60 md:flex-row  md:bg-transparent md:max-w-[80%] md:mt-[8rem] '>

                <div className=' md:w-[50%] '>
                    <img src={Phone3} alt="" className=' w-[30%] relative left-6 sm:w-[28%] md:w-[45%] mx-auto ' />
                </div>
                ...
                <div className=' md:w-[50%] '>
                    ...
                    <p className='text-center  text-white font-lol font-light text-[1rem] mt-4 md:text-left lg:text-2xl xl:mt-8 xl:text-[1.7rem] xl:leading-[2.5rem] 2xl:text-[2rem] 2xl:leading-[2.8rem] '></p>
