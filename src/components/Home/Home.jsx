...
const Home = () => {
    return (
        <div className='w-full font-lol'>
            ...
            <div className='flex flex-col justify-center items-center max-w-[90%] mx-auto mt-[4rem] gap-4 shadow-2xl py-8 rounded-2xl px-4 bg-[#000B70] bg-opacity-60 md:flex-row  md:bg-transparent md:max-w-[80%] '>
                ...
                <div className=' md:w-[50%]'>
                    ...
                    <h2 className=' text-center text-white font-lol font-bold text-2xl mt-4 md:text-left md:text-3xl xl:text-4xl 2xl:text-5xl '>TWÓRZ SWOJE WŁASNE <br /> LISTY ZAKUPÓW </h2>
                    <p className='text-center text-white font-lol font-light text-[1rem] mt-4 md:text-left lg:text-2xl xl:mt-8 xl:text-[1.7rem] 2xl:text-[2rem] '>i korzystaj z przykładowych list z <br /> “SKLEP LISTA” wszystko jest proste</p>
