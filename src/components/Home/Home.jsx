      ...
      >
        <div className=" md:w-[50%] ">
          <img
            src={Phone}
            alt=""
            className=" w-[30%]  sm:w-[28%] md:w-[40%] lg:left-12 2xl:w-[35%] mx-auto "
          />
        </div>
        ...
        <div className=" md:w-[50%] ">
          <h2 className=" text-center   text-white  font-bold text-2xl mt-4 md:text-left md:leading-[2.6rem] md:text-3xl lg:leading-[2.8rem] xl:text-4xl xl:leading-[3rem] 2xl:text-5xl 2xl:leading-[4rem] ">
            Creating your own shopping lists is a convenient and practical way
            to stay organized while shopping.
          </h2>
          <p className="text-center  text-white font-lol font-light text-[1rem] mt-4 md:text-left lg:text-2xl xl:mt-8 xl:text-[1.7rem] xl:leading-[2.5rem] 2xl:text-[2rem] 2xl:leading-[2.8rem] ">
            With our app, you can easily create custom lists for all your
            shopping needs, from groceries to household items and beyond.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className=" md:w-[50%]">
          <img
            src={Food}
            alt=""
            className=" w-[40%] sm:w-[37%] md:w-[70%] mx-auto md:mr-[20%] "
          />
        </div>
        ...
        <div className=" md:w-[50%]  ">
          <h2 className=" text-center   text-white font-lol font-bold text-2xl mt-4 md:text-left md:ml-[30%]  md:ml- md:leading-[2.6rem] md:text-3xl lg:leading-[2.8rem] xl:text-4xl xl:leading-[3rem] 2xl:text-5xl 2xl:leading-[4rem] ">
            Take full control of your list by filtering and editing your
            products.
          </h2>
          <p className="text-center  text-white font-lol font-light text-[1rem] mt-4 md:text-left md:ml-[30%] lg:text-2xl xl:mt-8 xl:text-[1.7rem] xl:leading-[2.5rem] 2xl:text-[2rem] 2xl:leading-[2.8rem] ">
            With our app, you can easily manage your inventory and make changes
            as needed. Stay organized and efficient by customizing your list to
      ...
      >
        <div className="  md:w-[50%]  ">
          <img
            src={Phone3}
            alt=""
            className=" w-[30%]  relative left-6 sm:w-[28%] md:w-[60%] md:left-16 lg:w-[45%] xl:left-24 mx-auto "
          />
        </div>
      ...
      >
        <div className=" md:w-[50%]">
          <img
            src={Phone4}
            alt=""
            className=" w-[40%] relative left-6 sm:left-14 sm:w-[37%] md:w-[50%] md:left-0 md:bottom-[100%] mx-auto md:mr-[20%] "
          />
        </div>
        ...
        <div className=" md:w-[50%] xl:pr-40">
          ...
          <p className="text-center  text-white font-lol font-light text-[1rem] mt-4 md:text-left lg:text-2xl xl:mt-8 xl:text-[1.7rem] xl:leading-[2.5rem] 2xl:text-[2rem] 2xl:leading-[2.8rem] ">
            Whether it's a shopping list, or a meals you can easily save and
            store your lists for future use.
          </p>
        </div>
      </motion.section>
    </motion.div>
